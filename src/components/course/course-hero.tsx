      ...
      >
        <div className="flex items-center gap-8">
          ...
          <div className="max-w-3xl flex-1">
            ...
            <h1 className="font-display mt-5 text-[40px] leading-[1.1] font-medium tracking-tight md:text-[52px]">
              {course.title}
            </h1>
            <p className="text-secondary mt-5 max-w-2xl text-base leading-relaxed">
              {course.description}
            </p>
